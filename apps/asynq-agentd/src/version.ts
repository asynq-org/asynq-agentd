...
export const DEFAULT_INSTALL_COMMAND = "curl -fsSL https://agentd.asynq.org/install.sh | sh -s -- --reuse-config --non-interactive --skip-pairing --skip-service-reload --skip-speech-setup";
